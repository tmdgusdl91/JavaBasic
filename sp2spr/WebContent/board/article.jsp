...
<div id="bbs">
	...
	<div id="bbsArticle">
		...
		<div id="bbsArticle_footer">
			<div id="leftFooter">
				<input type="button" value="수정" class="btn2" onclick="javascript:location.href='<%=cp %>/bbs/update.action?${params }';"/>
				<input type="button" value="삭제" class="btn2" onclick="javascript:location.href='<%=cp %>/bbs/delete.action?${params }';"/>
			</div>
			<div id="rightFooter"> 
