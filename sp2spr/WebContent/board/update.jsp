	...
	<div id="bbsCreated">
		<div class="bbsCreated_bottomLine">
			<dl>
				<dt>제&nbsp;&nbsp;&nbsp;&nbsp;목</dt>
				<dd>
					<input type="text" name="subject" size="65" maxlength="100" class="boxTF/" value="${dto.subject }">
				</dd>
			</dl>
		</div>
		...
		<div class="bbsCreated_bottomLine">
			<dl>
				<dt>작성자</dt>
				<dd>
					<input type="text" name="name" size="35" maxlength="20" class="boxTF" value="${dto.name }" readonly="readonly"/>
				</dd>
			</dl>
		</div>
		...
		<div id="bbsCreated_content">
			<dl>
				<dt>내&nbsp;&nbsp;&nbsp;&nbsp;용</dt>
				<dd>
					<textarea name="content" rows="12" cols="63" class="boxTA">${dto.content }</textarea>
				</dd>
			</dl>
		</div>
		...
		<div id="bbsCreated_footer">
			...
			<input type="button" value=" 수정하기 " class="btn2" onclick="asdf();"/>
			<input type="reset" value=" 다시입력 " class="btn2" onclick="document.myForm.subject.focus();"/>
			<input type="button" value=" 작성취소 " class="btn2" onclick="location='<%=cp %>/bbs/article.action?${params }';"/>
		</div>
	</form>
</div>
</body>
<script type="text/javascript">
	function asdf() {
		document.myForm.action = "<%=cp%>/bbs/update.action?${params }";
